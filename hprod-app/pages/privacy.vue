<template>
  <LazyHydrate when-visible>
    ...
    <main class="short-bg">
      ...
      <Header hero="Privacy Policy for Heuze Productions"/>
      <section class="block-privacy">

        <div class="container">
          <div class="content">
            <p>At Heuze Productions, accessible from https://heuzeproductions.com/, one of our main priorities is the privacy
              of our visitors. This Privacy Policy document contains types of information that is collected and recorded by
              Heuze Productions and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
              to the information that they shared and/or collect in Heuze Productions. This policy is not applicable to any
              information collected offline or via channels other than this website. Our Privacy Policy was created with the
              help of the <a href="https://www.generateprivacypolicy.com/">Privacy Policy Generator</a>.</p>
            <h2>Consent</h2>
            ...
            <h2>Log Files</h2>
            <p>Heuze Productions follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, Heuze Productions uses ‘cookies’. These cookies are used to store information including
            ...
            <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to
              ...
              the following URL – <a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a>
            </p>
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
              in their respective advertisements and links that appear on Heuze Productions, which are sent directly to users’
            ...
            <p>Note that Heuze Productions has no access to or control over these cookies that are used by third-party
              advertisers.</p>
            <h2>Third Party Privacy Policies</h2>
            <p>Heuze Productions’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
            ...
            <p>Heuze Productions does not knowingly collect any Personal Identifiable Information from children under the age
...
export default {
  ...
  modules: [],
  components: {LazyHydrate, Footer, Header}
}
</script>