<template>
  <section>
    <h1>Privacy Policy for HeuzeProductions</h1>
    <div>
      <p>At HeuzeProductions, accessible from https://heuzeproductions.com/, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of information that is collected and recorded by
        HeuzeProductions and how we use it.</p>
      ...
      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in HeuzeProductions. This policy is not applicable to any
      ...
      <h2>Log Files</h2>
      <p>HeuzeProductions follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <p>Like any other website, HeuzeProductions uses ‘cookies’. These cookies are used to store information including
      ...
      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on HeuzeProductions, which are sent directly to users’
      ...
      <p>Note that HeuzeProductions has no access to or control over these cookies that are used by third-party
        advertisers.</p>
      <h2>Third Party Privacy Policies</h2>
      <p>HeuzeProductions’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
      ...
      <p>HeuzeProductions does not knowingly collect any Personal Identifiable Information from children under the age
