<template>
  <LazyHydrate when-visible>
    ...
    <main class="short-bg">
      ...
      <Header hero="Age Calculator App Privacy Policy"/>
      <section class="block-privacy">

        <div class="container">
          <div class="content">
            <p>
              Heuze Productions built the Age Calculator App app as
              a Free app. This SERVICE is provided by
              Heuze Productions at no cost and is intended for use as
              is.
            </p> <p>
              ...
              Age Calculator App unless otherwise defined in this Privacy Policy.
              ...
              Privacy Policy, do not hesitate to contact me at jeromeheuze@gmail.com.
...
export default {
  head () {
    return {
      ...
      title: 'Age Calculator App Privacy Policy',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Age Calculator App Privacy Policy.'
        }
      ],
      style: [
      ],
