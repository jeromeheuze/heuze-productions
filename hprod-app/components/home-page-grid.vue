<template>
  <section class="home-page-grid">
          ...
          <div class="card-overlay">
            <div class="info-cont">
              <div class="icon-game-title">
                ...
                <div class="title-desc">
                  <h3>Solar Pioneer</h3>
                  <p>Destroy and complete each levels in our version of space combat similar to Galaga arcade shumps. Coming in 2022!</p>
                </div>
              </div>
              <div class="reviews">
                <img src="/img/star-15.svg" alt="" />
      ...
      <div class="game-grid middle-xs">
        ...
        <div class="card">
          ...
          <div class="card-overlay">
            <div class="info-cont">
              <div class="icon-game-title">
                <a href="https://e2production.com/" target="_blank"><img src="/img/e2production-96x96.png" alt="E2Production" /></a>
                <div class="title-desc">
                  <h3>E2Production</h3>
                  <p>Virtual businesses in the Earth2 Metaverse platform</p>
                </div>
              </div>
              <div class="reviews">
                <img src="/img/star-15.svg" alt="" />
            ...
            <div class="info-cont">
              <div class="icon-game-title">
                ...
                <div class="title-desc">
                  ...
                  <p>Purchase our quality themes for your favorite Jamstack framework like NuxtJS, Gatsby, Next, Hugo and Jekyll to accelerate your development time.</p>
                </div>
              </div>
              <div class="reviews">
                <img src="/img/star-15.svg" alt="" />
            ...
            <div class="info-cont">
              <div class="icon-game-title">
                ...
                <div class="title-desc">
                  ...
                  <p>You have a Jamstack framework and need to launch - discover top Jamstack Hosting services from our list.</p>
                </div>
              </div>
              <div class="reviews">
                <img src="/img/star-15.svg" alt="" />
    ...
    <div class="home-page-grid--cont">
      <h2>Our Video Game Community Support</h2>
      <div class="game-grid middle-xs">

        <div class="card">
          <div class="card-img">
            <a href="https://entropiahub.com/" target="_blank"><img src="/img/og-img-entropia-hub-default.jpg" alt="Entropia Hub" /></a>
          </div>
          <div class="card-overlay">
            <div class="info-cont">
              <div class="icon-game-title">
                <a href="https://entropiahub.com/" target="_blank"><img src="/img/entropiahub-64x64.png" alt="Entropia Hub" /></a>
                <div class="title-desc">
                  <h3>Entropia Hub</h3>
                  <p>Entropia Universe general information - filled with useful tools to help every entropian players.</p>
                </div>
              </div>
              <div class="reviews">
                <img src="/img/star-15.svg" alt="" />
