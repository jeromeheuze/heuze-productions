...
<head>
    <meta charset="utf-8">
    <title>E2Biz Properties | Heuze Productions - virtual business in Earth2.io and other Metaverse</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-8">
                <h2 class="line1">Earth2 virtual businesses (E2Biz)</h2>
            </div>
            ...
            <div class="block-cont">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">🗝️ Mystery House <span style="color:firebrick">[FOR SALE $15.00]</span></h5>
